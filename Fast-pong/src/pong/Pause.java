...
public class Pause {
		...
		if(enter) {
			...
			if(options[currentOption] == "Continue") {
				...
				if(Menu.screenMode == "window")
					Menu.screenMode = "full screen";
				
				else if(Menu.screenMode == "full screen")
					Menu.screenMode = "window";
				
				System.out.println(Menu.screenMode);
			}
	...
	public void render(Graphics g) {
		...
		//g.drawString("Sceen Mode: " + Menu.screenMode, (Game.WIDTH*Game.SCALE/2) - 63, (Game.HEIGHT*Game.SCALE/2) + 120 );
		...
		//	g.drawString(">", (Game.WIDTH*Game.SCALE/2) - 120, (Game.HEIGHT*Game.SCALE/2) + 120 );
		//}
